...
DEVICE_PATH := device/motorola/shamu
...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 14206186 # This is the maximum known partition size, but it can be higher, so we just omit it
